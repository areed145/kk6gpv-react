    ...
    <div>
      <div className="main">
        ...
        <CardDeck className="carddeck">
          <CardCell
            img={extra_300}
            caption="Aerobatics in an Extra 300"
            text={["Most of my times is in Cessna 172s with time in a Super Decathlon, RV-6A, and Extra 300L."]}
          />
          <CardCell
            img={super_decathlon}
            caption="Completed tailwheel and aerobatics training at KMIT"
            text={["My favorite flying experiences are checking out airport diners with friends, practicing aerobatics, and attending airshows."]}
          />
          <CardCell
            img={catalina}
            caption="On the ramp at KAVX, Catalina Island"
            text={["One highlight was a visit to Edwards AFB in the Mojave Desert and the NASA Armstrong Flight Research Center."]}
          />
        </CardDeck>
        <CardDeck className="carddeck">
          <CardCell
            ...
            text={["My main interests are in race/performance modifications, aircraft engines, aerobatics, and experimental aircraft."]}
          />
          <CardCell
            img={tehachapi}
            caption="Inbound to KBFL from KWJF"
            text={["Reno race fan. AOPA and EAA member. Military aviation buff. Tailwheel certified. Upset prevention & recovery and spin trained."]}
          />
          <CardCell
            img={salinas}
            caption="AOPA Salinas fly-in"
            text={["I am currently working towards a commercial / instructor certificate, and eventually plan to instruction the side."]}
          />
        </CardDeck>
        <CardDeck className="carddeck">
          <CardCell
            ...
            text={["In March of 2017 I co-purchased my first aircraft: Beechcraft A23-24 Super Musketeer N5777V, which is detailed on its own page."]}
          />
          <CardCell
