        ...
        <CardDeck className="carddeck">
          <CardResume
            ...
            roles={[
              ...
              "Performed decline curve analysis for these wells using in-house software",
              "Determined high value leases for further projection refinement",
        ...
        <CardDeck className="carddeck">
          <CardResume
            ...
            roles={[
              ...
              "Developed update-able pipeline cost spreadsheet model based on length, crossings, and variable material costs",
